...
export default function LoginFormDesktop() {
    ...
    const handleLogin = async () => {
        ...
        try {
            if (role === 'siswa') {
                // Login Siswa: Hanya cek apakah NIS ada di database
                ...
                // Jika NIS ditemukan, izinkan masuk (Simulasi login)
                navigate(`/dashboard/siswa`);
                return;
            }

            // Login Admin/Guru: Gunakan Email & Password standar Supabase Auth
            ...
            setErrorMsg(err.message || 'Login gagal. Silakan cek kembali data Anda.');
        } finally {
            setIsLoading(false);
        }
    };
                ...
                <div className="rounded-[26px] bg-white/90 p-6 shadow-[0_20px_50px_rgba(70,60,140,0.2)] backdrop-blur">
                    ...
                    <div className="mt-6 space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="role-select" className="ml-1 text-sm font-semibold text-slate-700">
                                Role
                            </label>
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="login-id" className="ml-1 text-sm font-semibold text-slate-700">
                        ...
                        {role !== 'siswa' && (
                            <div className="space-y-1.5">
                                <label htmlFor="login-password" className="ml-1 text-sm font-semibold text-slate-700">
                                    Password
                                </label>
                                <input
                                    id="login-password"
                    ...
                    <button
                        ...
                        onClick={handleLogin}
                        disabled={isLoading}
                        className="mt-5 w-full rounded-xl bg-gradient-to-r from-[#2f6bff] via-[#2e64ef] to-[#2656d0] py-3 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(40,86,208,0.35)] hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:hover:scale-100"
                    >
                    ...
                    <p className="mt-4 text-center text-sm text-slate-500">
                        Belum punya akun?{' '}
                        <a className="font-semibold text-[#2f6bff] hover:underline" href="#">
                            Daftar
                        </a>
                    </p>
                </div>
